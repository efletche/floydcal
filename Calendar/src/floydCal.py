...
class toDoList(wx.Frame):
    ...
    def pushEdit(self, event):
        """event that submits the entryData that edits a selected event on the selected day's schledule"""
    ...
    def onItemDeselected(self, event):
        """An event when an item on the ListCtrl is deselceted:
    ...
    def onItemSelected(self, event):
        """An event when an item on the ListCtrl is deselceted:
           ...
           Disables add, enables edit, ensables remove"""
        index = self.Cal_ControlList.GetFocusedItem()
    ...
    def updateView(self):
        """Refreshes the data of the Schledule every time data is add, removed, edited, or changed."""
